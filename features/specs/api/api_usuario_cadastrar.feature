...
Funcionalidade: [ API ] Cadastrar usuário
  ...
  Cenário: Cadastrar usuário com sucesso
    ...
    E também deverá salvar suas informações para realizar consultas futuras
  ...
  Esquema do Cenário: Tentar realizar cadastro de usuário com dados inválidos
    ...
    Exemplos:
      ...
      | 04/02/2020  | @analista     | 250.00,00  | 021.346.190-07  | paula     | 5.200,00  | m     |    1         | pj              | cargo: não utilizar números ou caracteres especiais |    
      ...
      | 07/02/2020  | qa            | 250.00,00  | 021.346.190-07  | 8@        | 8.300,00  | m     |    1         | pj              | nome: não utilizar números ou caracteres especiais  |
